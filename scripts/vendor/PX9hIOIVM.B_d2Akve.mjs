...
import { S as m, a as h, r as te, t as ne } from "./motion.CbDrufkU.mjs";
import {
  $ as re,
  C as g,
  D as _,
...
function le() {
  ...
  let t = null,
    n = !1;
  if (i.location.ancestorOrigins && i.location.ancestorOrigins.length > 0) {
    let e = i.location.ancestorOrigins[0];
    try {
      t = new URL(e).host;
    } catch {}
    ...
    return r && !a
      ...
      : s(e, {
          ...
          onClick: (e) => {
            (e.preventDefault(),
              i.open(
                `https://www.framer.com/r/badge/?utm_campaign=freeplanbadge&utm_source=${encodeURIComponent(i?.location?.origin)}`
              ));
          },
...
e(() => {
  (d(),
    ...
    (q = y(K)),
    (J = y(L)),
    (Y = x(L, { nodeId: `pBR1Ew0r8`, override: de, scopeId: `PX9hIOIVM` })),
    (X = ie(ce(x(m.a, { nodeId: `HK2sXlagE`, override: ue, scopeId: `PX9hIOIVM` })))),
    (Z = `framer-6jWyo`),
    (he = { HK2sXlagE: `framer-v-n0ccwk` }),
    (ge = {
      opacity: 1,
      rotate: 0,
      rotateX: 0,
    ...
    ($ = S(
      c(function (e, t) {
        let r = n(null),
          i = t ?? r,
          a = ee(),
          { activeLocale: o, setLocale: c } = ae();
        re();
        let { style: l, className: d, layoutId: f, variant: p, ...h } = Se(e),
          {
            baseVariant: ne,
            classNames: g,
            ...
            setVariant: x,
            variants: S,
          } = se({ defaultVariant: `HK2sXlagE`, ref: i, variant: p, variantClassNames: he }),
          C = Ce(e, S),
          w = _(Z);
        return s(te, {
          id: f ?? a,
            ...
            children: s(xe, {
              ...
              children: s(oe, {
                ...
                children: u(X, {
                  ...
                  __targetOpacity: 1,
                  className: `${_(w, `framer-n0ccwk`, d, g)} framer-bmpgw8`,
    ...
    g($, [{ explicitInter: !0, fonts: [] }, ...q, ...J], { supportsExplicitInterCodegen: !0 }),
    (Te = {
      exports: {
...
//# sourceMappingURL=PX9hIOIVM.B_d2Akve.mjs.map
