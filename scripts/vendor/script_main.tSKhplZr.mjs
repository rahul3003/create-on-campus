...
async function V({ routeId: e, pathVariables: n, localeId: i, collectionItemId: a }) {
      ...
      children: y(M, {
        children: y(N, {
          children: y(F, {
            ...
            framerSiteId: q,
            notFoundPage: D(
              () => import(`./_Mgoms052lCyaWHr9lSvjEy8tRraCtlinVbCX9g6-k4.BW7RJAtv.mjs`)
            ),
                ...
                : (() => {
                    ...
                    return D(async () => {
                      o.__framer_editorBarDependencies = {
                        __version: 3,
                        framer: { useCurrentRoute: R, useLocaleInfo: A, useRouter: P },
                        react: {
                          createElement: y,
                          Fragment: s,
                          memo: d,
            ...
            loadSnippetsModule: new z(
              () => import(`./zqZBG-ic4VVaYwCTj8fFnogiGf6a1EP1sP5XUXOpA0o.CGoWaLIy.mjs`)
            ),
...
`,
  ...
  try {
    ...
    if (e)
      ...
      if (!r || !i) {
        let e = x(W, decodeURIComponent(location.pathname), !0, G);
        ((r = e.routeId), (i = e.localeId), (a = e.pathVariables));
      }
    }
    let u = V({ routeId: r, localeId: i, pathVariables: a, collectionItemId: c?.collectionItemId });
    o !== void 0 &&
      (async () => {
        let e = W[r],
    ...
    e
      ? (B(`framer-rewrite-breakpoints`, () => {
          (O(s), o.__framer_onRewriteBreakpoints?.(s));
        }),
        (Y ? (e) => e() : l)(() => {
          (w(), k(), v(t, d, { onRecoverableError: n }));
        }))
  ...
  if (
    ...
    (W = {
      eQrbBJrm8: {
        ...
        page: D(() => import(`./dsPy1BvwsbqPrTharM7-CWLDllLFA3or245UHIK5qjw.B8MxVaEL.mjs`)),
        path: `/`,
      },
      YqRyTOoaI: {
        elements: {},
        page: D(() => import(`./v5C-hWuM6R7gmvDL13f5uhXjvZJz9WyCkEgYF5K-erM.I_JY3ChV.mjs`)),
        path: `/single-project`,
      },
      ivyNCPsQR: {
        elements: {},
        page: D(() => import(`./_Mgoms052lCyaWHr9lSvjEy8tRraCtlinVbCX9g6-k4.BW7RJAtv.mjs`)),
        path: `/404`,
      },
      oLLrzIi7Q: {
        collectionId: `aVKaIg1Yc`,
        elements: {},
        page: D(() => import(`./0crqohwf-_idF46f_rD9klSt4RQzSlL5ytcHKdZ1GmA.DFH3Yhbd.mjs`)),
        path: `/work/:IdLDCVSHS`,
      },
    }),
    ...
    (K = {
      aVKaIg1Yc: async () =>
        (await import(`./wVzXnTNZNLNoz_UqCgdAeVfw5owG-sg3CUCpmVo9dzE.D1nBVURm.mjs`))?.utils,
    }),
    (q = `7a53e9122a50fcda86681faea96651897b9c273a93e3b2fe8aa58aa1b3d975e6`),
    (J = typeof document < `u`),
    (Y = J && /bot|-google|google-|yandex|ia_archiver|crawl|spider/iu.test(a.userAgent)),
    J)
  ) {
    ((o.__framer_importFromPackage = (e, t) => () =>
      y(L, { error: `Package component not supported: "` + t + `" in "` + e + `"` })),
    ...
    J &&
      l(() => {
        v(
          ...
          y(m, {}, y(g(() => import(`./PX9hIOIVM.B_d2Akve.mjs`))))
        );
      });
  })();
})();
export { V as getPageRoot };
//# sourceMappingURL=script_main.tSKhplZr.mjs.map
