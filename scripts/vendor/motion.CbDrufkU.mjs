import { r as e, t } from "./rolldown-runtime.Bawp8BQ-.mjs";
import {
  A as n,
  C as r,
  D as i,
...
function Be(e, t) {
  let n = !1,
    ...
    a = () => (n = !0),
    o = sc.reduce((e, n) => ((e[n] = ze(a, t ? n : void 0)), e), {}),
    {
      setup: s,
      read: c,
      resolveKeyframes: l,
...
function Xe(e) {
  let t = Ke(e);
  return Je(t)(t.values.map((e, n) => Uc(e, t.split[n])));
}
function Ze(e, t, n) {
  return (
    n < 0 && (n += 1),
...
function Vt({ type: e, ...t }) {
  return Bt(e) && Nl() ? e.applyToOptions(t) : ((t.duration ??= 300), (t.ease ??= `easeOut`), t);
}
function Ht(e) {
  return e in Ll;
}
function Ut(e) {
  typeof e.ease == `string` && Ht(e.ease) && (e.ease = Ll[e.ease]);
}
function Wt(e) {
...
function mn(e, t, { delay: n = 0, transitionOverride: r, type: i } = {}) {
  ...
  for (let t in s) {
    ...
    r.start(ru(t, r, i, m && iu.has(t) ? { type: !1 } : o, e, p));
    let h = r.animation;
    h && d.push(h);
  }
  if (o) {
...
function xn(e, t, n) {
  ...
  for (; r < e.length && !i; ) {
    let t = e[r];
    (typeof t == `string` && !Tu.has(t) && Ke(t).values.length && (i = e[r]), r++);
  }
  ...
  let [r, i, a] = En(e, n),
    o = (e) => {
      ...
      let a = t(r, e),
        ...
        s = (e) => {
          o(e, r === c || r === document || n.useGlobalTarget || Au(r, e.target));
        },
        l = (e) => {
          o(e, !1);
        };
...
function Rn() {
  typeof ResizeObserver > `u` || (Ru = new ResizeObserver(Ln));
}
function zn(e, t) {
  Ru || Rn();
  let n = Sn(e);
  ...
  return (
    ...
    () => {
      (Hu.delete(e),
        !Hu.size &&
          typeof Uu == `function` &&
          (c.removeEventListener(`resize`, Uu), (Uu = void 0)));
    }
  );
}
function Hn(e, t) {
...
function tr(e) {
  return $n(e.animate) || Zu.some((t) => er(e[t]));
}
function nr(e) {
...
function Ir(e, t, n, r) {
  for (let n in (Dr(e, t, void 0, r), t.attrs)) e.setAttribute(vd.has(n) ? n : dn(n), t.attrs[n]);
}
function Lr(e, t, n) {
  let r = jr(e, t, n);
  for (let n in e)
...
function ri(e, t, n, r) {
  (ni(e.x, t, Ad, n ? n.x : void 0, r ? r.x : void 0),
    ni(e.y, t, jd, n ? n.y : void 0, r ? r.y : void 0));
}
function ii(e) {
  ...
  return class {
          ...
          e(t, () => {
            ...
            e !== r &&
              ...
              Vd.hasAnimatedSinceResize &&
                ((Vd.hasAnimatedSinceResize = !1), this.nodes.forEach(Ni)));
          }));
      }
    ...
    resetSkewAndRotation() {
      ...
      for (let t = 0; t < Ud.length; t++)
        (bi(`rotate${Ud[t]}`, e, r, this.animationValues),
          bi(`skew${Ud[t]}`, e, r, this.animationValues));
...
function oa(e) {
  typeof e == `function` && (ff = (t) => (t.startsWith(`on`) ? !aa(t) : e(t)));
}
function sa(e, t, n) {
  let r = {};
  for (let i in e)
...
function fa(e) {
  let { initial: t, animate: n } = da(e, d(pf));
...
function va(e, t, n, r) {
  let i = y(() => {
    let n = _f();
    return (Fr(n, t, yd(r), e.transformTemplate, e.style), { ...n.attrs, style: { ...n.style } });
  }, [t]);
  if (e.style) {
    let t = {};
...
function eo(e) {
  let [t, n] = Qi(),
    r = d(ks);
  return m(zf, { ...e, layoutGroup: r, switchLayoutGroup: d(hf), isPresent: t, safeToRemove: n });
}
function to(e, t, n) {
  let { props: r } = e;
...
function oo(e, t, n, r) {
  ...
  let l = r - c;
  i.velocity = l > ep ? 0 : Fe(i.current - s, l);
}
function so(e, t, n) {
...
function go(e, { container: t = document.scrollingElement, trackContentSize: n = !1, ...r } = {}) {
  ...
  if ((i.add(a), !cp.has(t))) {
    ...
    (c.addEventListener(`resize`, r),
      t !== document.documentElement && lp.set(t, Hn(t, r)),
...
function xo(e) {
  ...
  for (let [t, n] of mp) if (bo(e, t)) return { rangeStart: `${n} 0%`, rangeEnd: `${n} 100%` };
}
function So(e) {
  let t = { value: 0 };
  return {
...
function ko(e, t) {
  return c === void 0 ? !1 : e ? Ml() && !!xo(t) : jl();
}
function Ao({ container: e, target: t, ...r } = {}) {
  ...
  return (
    ...
    v(() => {
      if (s.current)
        return (
          P(!vp(e), `Container ref is defined but not hydrated`, `use-scroll-ref`),
          P(!vp(t), `Target ref is defined but not hydrated`, `use-scroll-ref`),
          c()
        );
    }, [c]),
    i
    ...
    let g = 0,
      _ = (e, n, r, o = 0, s = 0) => {
        ...
        if ((ee > 0 && bt(u, ee), c.length === 1 && c.unshift(null), m)) {
          (P(m < xp, `Repeat count too high, must be less than 20`, `repeat-count-high`),
            (b = qo(b, m)));
          let e = [...c],
            t = [...u];
...
function bs({ children: e, as: t = `ul`, axis: n = `y`, onReorder: r, values: i, ...o }, s) {
  let c = M(() => Qf[t]),
    l = [],
    u = a(!1),
    d = a(null);
  ...
  return m(c, {
    ...
    ref: p,
    ignoreStrict: !0,
    children: m(kp.Provider, { value: f, children: e }),
  });
}
function xs(e, t) {
...
function Es(e, t, n, r) {
  ...
  let i = ws(e, n);
  if (!i) return;
  let { amount: a, edge: o } = Ts(t - (n === `x` ? c.scrollX : c.scrollY), i, n);
  if (o === null) {
...
function Os(
  ...
  return m(l, {
    ...
    onDrag: (e, t) => {
      ...
      (_(n, f[h].get(), r[h]), Es(v.current, a[h], h, r[h]), i && i(e, t));
    },
    onDragEnd: (e, t) => {
      (Ss(), a && a(e, t));
    },
...
var ks,
  ...
  Rp = t(() => {
    (o(),
      ...
      (Oc = { test: Cc(`#`), parse: We, transform: Dc.transform }),
      (kc = (e) => ({
      ...
      (al = { decay: _t, inertia: _t, tween: wt, keyframes: wt, spring: ht }),
      (ol = class {
        constructor() {
          this.updateFinished();
        }
      ...
      (cl = class extends ol {
        ...
        initAnimation() {
          ...
          s !== wt &&
            typeof o[0] != `number` &&
            ((this.mixKeyframes = Ls(sl, st(o[0], o[1]))), (o = [0, 100]));
      ...
      (Ol = class {
        ...
        scheduleResolve() {
          ((this.state = `scheduled`),
            this.isAsync
              ? (wl.add(this), Tl || ((Tl = !0), B.read(Pt), B.resolveKeyframes(Nt)))
      ...
      (kl = (e) => e.startsWith(`--`)),
      (Al = {}),
      (jl = Lt(() => c.ScrollTimeline !== void 0, `scrollTimeline`)),
      (Ml = Lt(() => c.ViewTimeline !== void 0, `viewTimeline`)),
      (Nl = Lt(() => {
        try {
      ...
      (Ul = Pe(() => Object.hasOwnProperty.call(Element.prototype, `animate`))),
      (Wl = (e, t) =>
        t === `zIndex`
          ? !1
          : !!(
      ...
      (Eu = class extends Ol {
        ...
        measureInitialState() {
          ...
          (n === `height` && (this.suspendedScrollY = c.pageYOffset),
            (this.measuredOrigin = Cl[n](e.measureViewportBox(), c.getComputedStyle(e.current))),
        ...
        measureEndState() {
          ...
          let i = n.length - 1,
            a = n[i];
          ((n[i] = Cl[t](e.measureViewportBox(), c.getComputedStyle(e.current))),
      ...
      ({ schedule: Ou, cancel: ku } = Be(queueMicrotask, !1)),
      (Z = { x: !1, y: !1 }),
      ...
      (rd = class {
          ...
          ((this.current = e),
            ...
            this.reducedMotionConfig === `never`
              ...
              : this.reducedMotionConfig === `always`
                ...
                : ($u.current || ir(), (this.shouldReduceMotion = Qu.current)),
        ...
        readValue(e, t) {
          ...
          return (
            n != null &&
              (typeof n == `string` && (Ps(n) || Fs(n))
                ? (n = parseFloat(n))
                : !Gu(n) && q.test(t) && (n = yn(e, t)),
      ...
      (pd = class extends id {
        ...
        readValueFromInstance(e, t) {
          if (yl.has(t)) return this.projection?.isProjecting ? kt(t) : _l(e, t);
          {
            let n = Mr(e),
      ...
      (bd = class extends id {
        ...
        readValueFromInstance(e, t) {
          ...
          return ((t = vd.has(t) ? t : dn(t)), e.getAttribute(t));
        }
        scrapeMotionValuesFromProps(e, t, n) {
          return Lr(e, t, n);
        }
      ...
      (Qd = Si({
        ...
        defaultParent: () => {
          if (!Zd.current) {
            let e = new Yd({});
            (e.mount(c), e.setOptions({ layoutScroll: !0 }), (Zd.current = e));
          }
          return Zd.current;
        },
        resetTransform: (e, t) => {
      ...
      (ef = ({
        ...
        return (
          ...
          m(Ms.Provider, { value: p, children: e })
        );
      }),
      (tf = (e) => e.key || ``),
      (nf = ({
      ...
      (sf = ({ children: e, id: t, inherit: n = !0 }) => {
        ...
        c.current === null &&
          (of(n) && l && (t = t ? l + `-` + t : l),
          (c.current = { id: t, group: (af(n) && r.group) || Ki() }));
        let u = y(() => ({ ...c.current, forceRender: o }), [s]);
        return m(ks.Provider, { value: u, children: e });
      }),
      (cf = f({ strict: !1 })),
      (lf = {
        animation: [
    ...
    ((pf = f({})),
      ...
      (yf = mf({ scrapeMotionValuesFromProps: jr, createRenderState: gf })),
      (bf = mf({ scrapeMotionValuesFromProps: Lr, createRenderState: _f })),
      ...
      (Ef = (e) => (t) => ju(t) && e(t, ja(t))),
      (Df = (e, t) => Math.abs(e - t)),
      (Of = (e, t) => ((t.isSVG ?? ya(e)) ? new bd(t) : new pd(t, { allowProjection: e !== l }))),
      ...
      (Pf = class {
        ...
        startAxisValueAnimation(e, t) {
          ...
          return (un(this.visualElement, e), n.start(ru(e, n, 0, t, this.visualElement, !1)));
        }
        stopAnimation() {
      ...
      (Bf = { pan: { Feature: Lf }, drag: { Feature: Ff, ProjectionNode: Qd, MeasureLayout: eo } }),
      (Vf = class extends ad {
        mount() {
      ...
      (Zf = { layout: { ProjectionNode: Qd, MeasureLayout: eo } }),
      (Qf = Aa({ ...Tf, ...Xf, ...Bf, ...Zf }, Of)),
      ($f = { renderer: Of, ...Tf, ...Xf }),
      { ...$f, ...Bf, ...Zf },
      { ...Tf },
      (ep = 50),
      ...
      (dp = new WeakMap()),
      (fp = new WeakMap()),
      (pp = (e) => (e === document.scrollingElement ? c : e)),
      (mp = [
        [op.Enter, `entry`],
        [op.Exit, `exit`],
        [op.Any, `cover`],
...
//# sourceMappingURL=motion.CbDrufkU.mjs.map
