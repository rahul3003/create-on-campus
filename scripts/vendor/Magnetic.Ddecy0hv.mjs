...
import { B as m, F as h, S as g, a as _, r as v, t as y } from "./motion.CbDrufkU.mjs";
import {
  $ as b,
  C as x,
  D as S,
...
var M = e({ __FramerMetadata__: () => J, default: () => q });
function N(e, ...t) {
  let n = {};
...
var P,
  ...
  Y = t(() => {
    (f(),
      ...
      y(),
      n(),
      (P = [`QFWHYUKeG`, `QOzbj5N5y`, `FtNpFJjRL`]),
      (F = `framer-GBd4B`),
      (I = {
      ...
      (L = { duration: 0, type: `tween` }),
      (R = { damping: 60, delay: 0, mass: 1, stiffness: 500, type: `spring` }),
      (z = (e, t) => `translate(-50%, -50%) ${t}`),
      (B = (e, t) => `translateX(-50%) ${t}`),
      (V = ({ value: e, children: t }) => {
        let n = o(_),
          r = e ?? n.transition,
          i = u(() => ({ ...n, transition: r }), [JSON.stringify(r)]);
        return s(_.Provider, { value: i, children: t });
      }),
      (H = g(i)),
      (U = { Default: `QFWHYUKeG`, Hover: `QOzbj5N5y`, Mid: `FtNpFJjRL` }),
      (W = ({ bG: e, height: t, id: n, label: r, link: i, width: a, ...o }) => ({
        ...o,
        nAraFIBQl:
          e ?? o.nAraFIBQl ?? `var(--token-0ea8e2e5-e7ab-4f28-af8b-2269b349f920, rgb(13, 50, 114))`,
        S5EqVDFx5: r ?? o.S5EqVDFx5 ?? `Get started now`,
        variant: U[o.variant] ?? o.variant ?? `QFWHYUKeG`,
        XPPtN6fX6: i ?? o.XPPtN6fX6,
      })),
      (G = (e, t) => (e.layoutDependency ? t.join(`-`) + e.layoutDependency : t.join(`-`))),
      (K = O(
        c(function (e, t) {
          let { activeLocale: n, setLocale: a } = T(),
            {
              style: o,
              className: c,
              layoutId: l,
            ...
            } = W(e),
            {
              ...
              setVariant: U,
              variants: K,
            } = D({ cycleOrder: P, defaultVariant: `QFWHYUKeG`, variant: u, variantClassNames: I }),
            q = G(e, K),
            { activeVariantCallback: J, delay: Y } = ee(y),
            X = J(async (...e) => {
              (M({ isHovered: !0 }), U(`QOzbj5N5y`));
            }),
            Z = J(async (...e) => {
              (M({ isHovered: !1 }), U(`FtNpFJjRL`));
            });
          k(y, {
            FtNpFJjRL: J(async (...e) => {
              await Y(() => U(`QFWHYUKeG`), 450);
            }),
          });
          let Q = r(null),
            $ = p(),
          ...
          return (
            ...
            s(v, {
              ...
              children: s(H, {
                ...
                children: s(V, {
                  value: L,
                  ...N({ FtNpFJjRL: { value: R }, QOzbj5N5y: { value: R } }, y, O),
                  children: s(E, {
                    href: h,
                    openInNewTab: !0,
                    children: d(g.a, {
                      ..._,
                      ...w,
                      className: `${S(F, ...te, `framer-1ci6myn`, c, x)} framer-zcdww3`,
                        ...
                        d(g.div, {
                          ...
                          children: [
                            s(j, {
                              ...
                              ...N(
                                {
                                  FtNpFJjRL: { transformTemplate: B },
                                  QOzbj5N5y: { transformTemplate: B },
                                },
                                y,
                                O
                              ),
                            ...
                            s(j, {
                              ...
                              verticalAlignment: `top`,
                              withExternalLayout: !0,
                              ...N({ QOzbj5N5y: { transformTemplate: z } }, y, O),
                            }),
                            s(j, {
                              __fromCanvasComponent: !0,
                              children: s(i, {
      ...
      (K.defaultProps = { height: 56, width: 183 }),
      A(K, {
        variant: {
        ...
        XPPtN6fX6: { title: `Link`, type: w.Link },
      }),
      x(
        K,
        [
            ...
            let e = (e) => {
              if (u.current) {
                let t = u.current.getBoundingClientRect(),
                  ...
                  a = e.clientX - r,
                  s = e.clientY - i;
                n ? (o.set(a * Z), c.set(s * Z)) : (o.set(0), c.set(0));
              }
            };
            return (
...
export { M as a, q as i, Q as n, Y as r, $ as t };
//# sourceMappingURL=Magnetic.Ddecy0hv.mjs.map
